...
](https://www.microsoft.com/en-us/download/details.aspx?id=49117). The detailed instruction are available [here](https://docs.microsoft.com/en-us/deployoffice/office2019/deploy). I recommend you to download all necessary files before installation.
